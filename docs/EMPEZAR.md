...
Para continuar en otro equipo, abre Compas.html y pulsa «Abrir respaldo». Selecciona tu JSON. Abrir otro respaldo reemplaza la bitácora actual: descarga primero los cambios que quieras conservar.

## 4. Comparte una selección
...
## Video demo
En la carpeta encontrarás Compas-demo.mp4: un recorrido de aproximadamente 3 minutos y 36 segundos, con datos ficticios, narración en español y subtítulos integrados.
